	...
	public static void main(String[] args){
		...
		/*
			String 클래스
				...
				String값은 불변 값이다. 한번 만들어진 이후에는 변경할 수 없다.
		...
		*/
		...
		System.out.println("동일한 문자열인가?"+equal2);
		...
		System.out.println("문자열에서 [프로그램]이라는 글자가 처음으로 등장하는 위치는?" + index);

		// 문자열의 내용을 지정된 문자열로 대체한 새로운 문자열을 반환하는 메소드 : String replace(String target,String str)
		String str9=str8.replace("자바","파이선");
		...
		// String valueOf(int 값), String valueOf(double value), String valueOf(boolean value)
		int number = 1234;
		//숫자 1234을 문자열 "1234"으로 변환해서 반환한다.
